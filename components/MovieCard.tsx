...
function MovieCard({ movie }: { movie: Movie }) {
  return (
    <div className="relative flex-shrink-0 cursor-pinter transform hover:scale-105 transition duration-200 ease-out hover:drop-shadow-lg">
      ...
      <Image
        ...
        src={getImagePath(movie.poster_path || movie.poster_path)}
        alt={movie.title}
        width={500}
        height={300}
      />
